const Tentang = () => {
  ...
  <div className="hero-content flex-col lg:flex-row-reverse border-2 border-white rounded-lg">
    ...
    <div className="hero-content text-center">
      ...
      Saya Mochammad Faith Afdhal Santoso, saya seorang junior front-end developer. Hobi saya adalah Bermain SepakBola, Main game, dan Programming. Saat ini, saya tengah menekuni pendidikan di SMKN 13 Bandung, di mana saya belajar untuk mengembangkan keterampilan dalam bidang teknologi.
      </p>
      </div>
    </div>
  </div>
