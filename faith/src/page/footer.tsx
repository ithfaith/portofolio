...
const Footer = () => {
    return (
      ...
      <h6 className="font-ruslan text-white"><Link activeClass="active" to="hero" spy={true} smooth={true} offset={-70} duration={500} className='desktopMenuListItem'>Mochammad Faith</Link></h6>
      </div>
      </nav>
      <nav>
